...
int main(int argc, char * argv[]) {
...

  {
    ...
    // Vector of four mass matrices, built from the following combinations
    ...
    { // START SCOPE 2: Tensor product of Gauss-Legendre, Gauss-Lobatto and Gauss-Lobatto rules.
      ...
      const auto line_cubature_x = Intrepid2::CubaturePolylib<PHX::Device::execution_space, double, double>(quad_order, Intrepid2::POLYTYPE_GAUSS);
