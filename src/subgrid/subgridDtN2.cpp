...
void SubGridDtN2::createNewBoundaryCells(SubGridTools2 & sgt, size_t & mindex) {
...
void SubGridDtN2::createNewCells(SubGridTools2 & sgt, size_t & mindex) {
...
void SubGridDtN2::setBoundaryCellAuxLIDs(size_t & mindex) {
