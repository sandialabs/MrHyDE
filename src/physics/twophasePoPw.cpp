...
void twophasePoPw::defineFunctions(Teuchos::ParameterList & fs,
  ...
  functionManager->addFunction("cap press inverse",fs.get<string>("capillary pressure inverse","1.0"),"ip");
  functionManager->addFunction("dcap press inverse",fs.get<string>("derivative capillary pressure inverse","0.0"),"ip");
...
void twophasePoPw::setVars(std::vector<string> & varlist) {
