...
namespace MrHyDE {
  ...
  private:
    ...
    bool include_Beqn, include_Eeqn;
    ...
    ScalarT current_fr_center_, current_fr_band_, current_offset_, current_amplitude_, current_sigma_;
    ScalarT current_xmin_, current_xmax_, current_ymin_, current_ymax_, current_zmin_, current_zmax_;
    View_Sc2 current_x, current_y, current_z;
    
    // Isotropic PML parameters
    bool use_iPML;
    ScalarT iPML_sigma;
    ScalarT PML_B_factor;
    string iPML_type;
    bool iPML_have_xmin, iPML_have_xmax, iPML_have_ymin, iPML_have_ymax, iPML_have_zmin, iPML_have_zmax;
    ScalarT iPML_tol_xmin, iPML_tol_xmax, iPML_tol_ymin, iPML_tol_ymax, iPML_tol_zmin, iPML_tol_zmax;
    ScalarT iPML_pow_xmin, iPML_pow_xmax, iPML_pow_ymin, iPML_pow_ymax, iPML_pow_zmin, iPML_pow_zmax;
    ScalarT iPML_sigma_xmin, iPML_sigma_xmax, iPML_sigma_ymin, iPML_sigma_ymax, iPML_sigma_zmin, iPML_sigma_zmax;
    ScalarT iPML_xmin_start, iPML_xmax_start, iPML_ymin_start, iPML_ymax_start, iPML_zmin_start, iPML_zmax_start;
    ScalarT iPML_xmin_end, iPML_xmax_end, iPML_ymin_end, iPML_ymax_end, iPML_zmin_end, iPML_zmax_end;
    ScalarT iPML_zmin_x1, iPML_zmin_x2, iPML_zmin_y1, iPML_zmin_y2;
    ScalarT iPML_zmax_x1, iPML_zmax_x2, iPML_zmax_y1, iPML_zmax_y2;
    ...
    ScalarT aPML_tol_xmin, aPML_tol_xmax, aPML_tol_ymin, aPML_tol_ymax, aPML_tol_zmin, aPML_tol_zmax;
    ScalarT aPML_pow_xmin, aPML_pow_xmax, aPML_pow_ymin, aPML_pow_ymax, aPML_pow_zmin, aPML_pow_zmax;
    ScalarT aPML_sigma_xmin, aPML_sigma_xmax, aPML_sigma_ymin, aPML_sigma_ymax, aPML_sigma_zmin, aPML_sigma_zmax;
    ScalarT aPML_xmin_start, aPML_xmax_start, aPML_ymin_start, aPML_ymax_start, aPML_zmin_start, aPML_zmax_start;
    ScalarT aPML_xmin_end, aPML_xmax_end, aPML_ymin_end, aPML_ymax_end, aPML_zmin_end, aPML_zmax_end;
    ScalarT aPML_zmin_x1, aPML_zmin_x2, aPML_zmin_y1, aPML_zmin_y2;
    ScalarT aPML_zmax_x1, aPML_zmax_x2, aPML_zmax_y1, aPML_zmax_y2;
    bool aPML_zmin_exclude, aPML_zmax_exclude;
    
    View_Sc2 aPML_xx, aPML_yy, aPML_zz;
    
    // Various other mirage closure model parameters
    ScalarT mirage_epsilon, mirage_mu, mirage_ri, mirage_sigma;
