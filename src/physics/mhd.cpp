...
//             Fx *= wts(elem, pt);
//             AD Fy = visc(elem, pt) * duy_dy(elem, pt) + By(elem, pt) * By(elem, pt) / mu(elem, pt) - (norm_B / (2 * mu(elem, pt)) + pr(elem, pt));
//             Fy *= wts(elem, pt);
...
//             AD Fx = 0.;
//             Fx *= wts(elem, pt);
//             AD Fy = By(elem,pt)*ux(elem,pt)-uy(elem,pt)*Bx(elem,pt) - eta(elem,pt)*(dBx_dy(elem,pt) - dBy_dx(elem,pt));
//             Fy *= wts(elem, pt);
//             AD Fz = Bz(elem,pt)*ux(elem,pt)-uz(elem,pt)*Bx(elem,pt) - eta(elem,pt)*(dBx_dz(elem,pt) - dBz_dx(elem,pt));
//             Fz *= wts(elem, pt);
//             AD F = dBx_dt(elem, pt);
//             F *= wts(elem, pt);
//             for (size_type dof = 0; dof < basis.extent(1); dof++)
