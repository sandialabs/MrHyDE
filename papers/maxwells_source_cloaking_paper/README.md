...
- For compliance reasons, we run the examples on a micro-scale, so you need to rescale the generated meshes to the 1e-6 scale to reproduce our results. You can do this rescaling with the `grepos` library in trilinos.
