...
desc = '''Tracking-target LQ hessVec check with trk_gate. On the incremental
adjoint sweep, trk_gate is zeroed so AD returns f_yy w and algebraic checks
pass at roundoff.'''
...
#TESTING active
#TESTING -n 4
#TESTING -k thermal,optimization,hessvec,lq,tracking
...
# Min Rayleigh value across directions.
...
# "relative =" scalar for tagged line.
