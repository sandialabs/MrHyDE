...
desc = ''' LQ Hessian-vector checks for a small transient Maxwell E-B control
case using the exact HessVec path. Asserts on [HV-*] and Hessian symmetry. '''
...
# Hessian symmetry relative error.
...
# Minimum Rayleigh value from both directions.
...
# Parse "relative =" scalar for a tag.
